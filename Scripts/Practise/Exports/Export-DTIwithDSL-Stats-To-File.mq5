...
void OnStart()
  {
   ...
   string fileName = StringFormat("%s_%s_DtiWithDsl.csv", _Symbol, EnumToString(_Period));
   ...
   int handle = iCustom(_Symbol, _Period, "Okmich\\Directional Trend Index (DSL)", 40, 20, 5, 5);
