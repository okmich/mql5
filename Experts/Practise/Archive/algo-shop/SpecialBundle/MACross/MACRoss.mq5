...
input string   inpComment           = "MA CROSS"; //Trade Comment
...
input ushort   InpTakeProfit     = 70;       // Take Profit, in pips
...
input int                  Inp_MA_Fast_ma_period=80;// MA Fast: averaging period
...
void CheckSignal(bool &buy_signal,bool &sell_signal)
  {
   ...
   if(count_sells < InpMaxSellPositions && ma_fast[2] > ma_slow[2] && ma_fast[1] < ma_slow[1])
     {
      sell_signal = true;
     }
