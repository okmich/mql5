...
//--- input parameters
input int InpPeriodADXW=13;   // DMI Period
input int InpPeriodADX=8;     // ADX Period
...
//--- indicator short name
   string short_name="ADX Wilder("+string(ExtADXWPeriod)+ "," + string(InpPeriodADX)+ ")";
   ...
   for(int i=start; i<rates_total && !IsStopped(); i++)
     {
      ...
      ExtADXWBuffer[i]=SmoothedMA(i,InpPeriodADX,ExtADXWBuffer[i-1],ExtDXBuffer);
     }
